...
static void _nc_galaxy_sd_position_flat_gen (NcGalaxySDPosition *gsdp, NcmVector *pos, NcmRNG *rng);
...
static void
_nc_galaxy_sd_position_flat_gen (NcGalaxySDPosition *gsdp, NcmVector *pos, NcmRNG *rng)
{
